...
function AdminPanel() {
  ...
  const { toggleMode, mode,products,loading,setLoading,product,setProducts,getProductData } = context
                  ...
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                    ...
                    <tbody className=''>
                      {product.map((item, index) => {
                        ...
                        //  const category = item.allcategory.map((catItem)=> catItem.category)
                        //  const subCategory = item.allcategory.map((catItem)=> catItem.subCategory)
                        return (
